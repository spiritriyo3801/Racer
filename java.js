...
let player = { speed: 6.5 , score: 0};
let player2 = { speed2: 8.5};
...
function endGame(){
    ...
    startScreen.innerHTML = "Game Over <br> Your Final Score is " + player.score +"<br>Click Here to Restart Your Game.";
...
function start() {
    ...
    //car.innerText = "Imagine This is a car";
...
function randomColour(){
    function c(){
        let hex = Math.floor(Math.random() * 256). toLocaleString(16);
